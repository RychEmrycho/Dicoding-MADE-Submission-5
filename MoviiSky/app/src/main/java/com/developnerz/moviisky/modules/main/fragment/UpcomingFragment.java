...
public class UpcomingFragment extends Fragment implements UpcomingAdapter.OnClickItemListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            moviesData = savedInstanceState.getParcelableArrayList(Variables.FRAGMENT_UPCOMING_TAG);
        }
        setUpLayout();
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        if (moviesData != null) {
            outState.putParcelableArrayList(Variables.FRAGMENT_UPCOMING_TAG, new ArrayList<>(moviesData));
        }
    }
    void refreshData() {
